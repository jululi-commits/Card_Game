...
class EscenaGameOver(EscenaBase):
    ...
    def __init__(self) -> None:
        ...
        self.cartas_apiladas: int = 0
        self.pilones_armados: int = 0
    ...
    def al_entrar(self, **kwargs: Any) -> None:
        ...
        self.cartas_apiladas = kwargs.get("cartas_apiladas", 0)
        self.pilones_armados = kwargs.get("pilones_armados", kwargs.get("casillas_ocupadas", 7))
    ...
    def dibujar(self, pantalla: pygame.Surface) -> None:
        ...
        if es_victoria:
            tercera_stat = f"Pilones Armados: {self.pilones_armados} / 20"
        else:
            tercera_stat = f"Cartas Apiladas: {self.cartas_apiladas} / 52"
